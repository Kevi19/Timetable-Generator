...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">COLLEGE OF APPLIED SCIENCE, MAVELKKARA</h3>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/clg1.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/clg2.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/clg3.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/clg2.jpg" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/photo.jpg" class="img-rounded"/>
                    <h3 align="center">Mrs. Latha Nair J</h3>
                    <hr/>
                    <h4 align="center">HOD, Computer Scence<br/</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/photo.jpg" class="img-rounded"/>
                    <h3 align="center">Mrs. Laila Jasmin</h3>
                    <hr/>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>Govt.BHSS compound
                </h4>
                <h4> Mavelkara</h4>
                <h4><strong>Call:</strong> 0479 230 4494 </h4>
                <h4><strong>Email: </strong>casmmvk@gmail.com</h4>
            </div>
