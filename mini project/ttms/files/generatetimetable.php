        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        echo "COMPUTER SCIENCE DEPARTMENT " . $_POST['select_semester'] . " ";
            ...
            <tr>
                ...
                <td style="text-align:center">9:30- 10:25</td>
                <td style="text-align:center">10:25-11.20</td>
                <td style="text-align:center">11.30-12:30</td>
                <td style="text-align:center">12:30-1:15</td>
                <td style="text-align:center">1:15-2:15</td>
                <td style="text-align:center">2:15-3:15</td>
                <td style="text-align:center">3:15-4:15</td>
                ...
                <td style=\"text-align:center\">LUNCH</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM,CASM";
